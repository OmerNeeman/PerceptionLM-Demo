...
| S5 | **blocked on owner** | text tower measured at **123.7 M params = 247 MB fp16, 15.5x the entire 16 MB cap** — a standalone offline file cannot embed arbitrary typed text | owner decision on the export's query model |
